...
from .block import DANetHead, CAM_Module
def INF(B,H,W):
...
class ExactNet(torch.nn.Module):
    def __init__(self, t_length = 5, n_channel =3):
        ...
        self.encoder = SwinTransformer(in_chans=n_channel*(t_length-1), embed_dim=64, pretrain_img_size=256, depths=[2, 2, 6], num_heads=[2, 4, 8], window_size=7, patch_size=1, out_indices=(0, 1, 2))
