...
from .EfficentNet_Ghost112SE import EfficentNet_Ghost112SE_b0
from .EfficentNetGhost112SE_linetoconv import EfficentNetGhost112SE_linetoconv_b0
...
class BaseModel(nn.Module):
    def __init__(self, name, num_classes):
        ...
        elif name == 'EfficentNetGhost112SEb0':
            self.base = EfficentNet_Ghost112SE_b0(num_classes=num_classes)
        elif name == 'EfficentNetGhost112SElinetoconvb0':
            self.base = EfficentNetGhost112SE_linetoconv_b0(num_classes=num_classes)
