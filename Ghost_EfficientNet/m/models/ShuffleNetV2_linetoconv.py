...
class ShuffleNetV2(nn.Module):
    def __init__(self, planes, layers, groups, num_classes=1000):
        ...
        self.conv_line_depth = nn.Sequential(
            nn.Conv2d(in_channels=planes[3], out_channels=planes[3], kernel_size=7, stride=1,
                      groups=planes[3]),
...
def sShuffleNetV2_linetoconv_x0_5(**kwargs):
...
def ShuffleNetV2_linetoconv_x1_0(**kwargs):
...
def ShuffleNetV2_linetoconv_x1_5(**kwargs):
...
def ShuffleNetV2_linetoconv_x2_0(**kwargs):
