...
if __name__ == '__main__':
    ...
    # model_list = ['MobileNet_v2', 'MobileNet_v3', 'ShuffleNet_v1', 'ShuffleNet_v2', 'EfficientNet_v1_B0','EfficientNetV2_s', 'GhostNet', 'ConvNext']
    model_list = ['MobileV3sghostse','mymodel']
    record_files = ['record_tl.xlsx', 'record_ta.xlsx', 'record_vl.xlsx', 'record_va.xlsx', 'record_lr.xlsx']
    for record_file in record_files:
        if not os.path.exists(record_file):
            df = pd.DataFrame()
            df.to_excel(record_file)
    n = pd.read_excel(record_files[0])
