...
def cluster(t, criterion):
    news_data_files = os.listdir(r'../CompareTrail/JiangCommunication/final_input')
    path_cluster = r'../CompareTrail/JiangCommunication/jiang_cluster/{0}_cluster.txt'.format(t)
    f_cluster = open(path_cluster, 'w', encoding='utf-8')
    for news_data_file in news_data_files:
        path = r'../CompareTrail/JiangCommunication/final_input/' + news_data_file
        print(path)
