...
def cluster(t, criterion):
    news_data_files = os.listdir(r'D:\workspace\pycharm\PaperTrail\CompareTrail\ZhangqiangCISC\final_result')
    path_cluster = r'D:\workspace\pycharm\PaperTrail\CompareTrail\ZhangqiangCISC\distance_cluster\{0}_cluster.txt'.format(t)
    f_cluster = open(path_cluster, 'w', encoding='utf-8')
    for news_data_file in news_data_files:
        path = r'D:\workspace\pycharm\PaperTrail\CompareTrail\ZhangqiangCISC\final_result' + '\\' + news_data_file
