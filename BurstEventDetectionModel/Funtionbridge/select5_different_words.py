...
# @Time :2022/10/6 0006 10:09
# @Author :bay
# @File select5_different_words.py
# @Software : PyCharm
# -*--coding:utf-8 -*--
...
if __name__ == "__main__":
    compare_file(r'D:\workspace\pycharm\PaperTrail\results\event_values\0.0001_event.txt',
                 r'D:\workspace\pycharm\PaperTrail\results\event_values\9e-05_event.txt')  # 传入两文件的路径
