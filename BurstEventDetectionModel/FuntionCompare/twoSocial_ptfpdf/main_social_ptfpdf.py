...
from FuntionCompare.twoSocial_ptfpdf.code4merge_three import merge_three
from FuntionCompare.twoSocial_ptfpdf.code5bursty_similiarity import similiary
from FuntionCompare.twoSocial_ptfpdf.code6cluster import cluster
# 测试数据
