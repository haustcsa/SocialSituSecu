...
# data specifications 
parser.add_argument('--dir_image', type=str, default='..\examples\\face\image\inputs',
...
parser.add_argument('--rates', type=str, default='1+2+4+8',
                    help='dilation rates used in block')
...
parser.add_argument('--tensorboard', action='store_true',
                    help='default: false, since it will sow training. use it for debugging')

# test and demo specifications
parser.add_argument('--pre_train', type=str, default='..\experiments\..',
                    help='path to pretrained models')
parser.add_argument('--outputs', type=str, default='..\examples\\face\image\outputs',
