...
def process_videos(videos, detector_cls: Type[VideoFaceDetector], selected_dataset, opt):
    ...
    for item in tqdm(loader):
        ...
        sample_indices = np.linspace(0, total_frames - 1, num=30, dtype=int)
        ...
        batches = [sampled_frames[i:i + detector._batch_size] for i in
                   range(0, len(sampled_frames), detector._batch_size)]
...
def main():
    ...
    parser.add_argument('--data_path', default='G:\Celeb-DF-v2\Celeb-real/videos', type=str,
                        help='Videos directory')
    parser.add_argument("--detector-type", help="Type of the detector", default="FacenetDetector",
                        choices=["FacenetDetector"])
    parser.add_argument("--processes", help="Number of processes", default=0)
