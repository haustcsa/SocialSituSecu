...
from utils import get_method, check_correct, resize, shuffle_dataset, get_n_params, check_correct_10
...
BASE_DIR = 'G:\DFDC\dfdc_train_Part_49'
...
def read_frames(video_path, train_dataset, validation_dataset):
    ...
    with open('F:\FFtest/architecture.yaml', 'r') as ymlfile:
    ...
    frames_interval = int(frames_number / 60)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', default='F:/Com_T_pth/efficientnet_checkpoint6_All', type=str, metavar='PATH',
    # parser.add_argument('--resume', default='F:\Com_T_pth\pthDFDC/efficientnet_checkpoint1_DFDC', type=str, metavar='PATH',
